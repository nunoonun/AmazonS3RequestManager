...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AmazonS3RequestManager-tvOS/AmazonS3RequestManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SWXMLHash-tvOS/SWXMLHash.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Nimble-tvOS/Nimble.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Nocilla-tvOS/Nocilla.framework"
