...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AmazonS3RequestManager-macOS/AmazonS3RequestManager.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Nocilla-macOS/Nocilla.framework"
